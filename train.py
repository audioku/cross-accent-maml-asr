...
if __name__ == '__main__':
    ...
    train_loader = AudioDataLoader(train_data, 0, num_workers=args.num_workers, batch_sampler=train_sampler)
    ...
    for i in range(len(args.valid_manifest_list)):
        ...
        valid_loader = AudioDataLoader(valid_data, 0, num_workers=args.num_workers)
