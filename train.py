...
if __name__ == '__main__':
    ...
    train_loader = AudioDataLoader(0, train_data, num_workers=args.num_workers, batch_sampler=train_sampler)
    ...
    for i in range(len(args.valid_manifest_list)):
        ...
        valid_loader = AudioDataLoader(0, valid_data, num_workers=args.num_workers)
