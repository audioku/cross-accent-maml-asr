...
if __name__ == '__main__':
    ...
    train_loader = AudioDataLoader(pad_id=0, dataset=train_data, num_workers=args.num_workers, batch_sampler=train_sampler)
    ...
    for i in range(len(args.valid_manifest_list)):
        ...
        valid_loader = AudioDataLoader(pad_id=0, dataset=valid_data, num_workers=args.num_workers)
