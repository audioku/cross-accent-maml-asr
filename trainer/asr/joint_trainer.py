...
class JointTrainer():
    ...
    def forward_one_batch(self, model, vocab, src, trg, src_percentages, src_lengths, trg_lengths, smoothing, loss_type, verbose=False, accent_id=None, multi_task=False):
        ...
        while it < num_it:
            ...
            try:
                ...
                for manifest_id in range(len(train_tmp_buffer)):                
                    ...
                    # Train
                    tr_loss, tr_cer, tr_num_char = self.forward_one_batch(model, vocab, tr_inputs, tr_targets, tr_percentages, tr_input_sizes, tr_target_sizes, smoothing, loss_type, verbose=False, accent_id=None)
