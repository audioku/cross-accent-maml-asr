...
class SpectrogramDataset(Dataset, SpectrogramParser):
    ...
    def __getitem__(self, index):
        if self.is_train:
            ...
            audio_path, transcript_path = sample[0], sample[1]
            spect = self.parse_audio(audio_path)[:,:constant.args.src_max_len]
            transcript, target_transcript = self.parse_transcript(transcript_path, lang_id=0)
        # print(transcript, target_transcript)
    ...
    def parse_transcript(self, transcript_path, lang_id=0):
        ...
        # print(lang_id, cur_transcript, "transcript:", len(transcript), "target_transcript:", len(target_transcript))
